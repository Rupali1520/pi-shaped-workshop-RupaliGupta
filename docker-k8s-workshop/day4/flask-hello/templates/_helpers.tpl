...
{{ include "flask-hello.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "flask-hello.selectorLabels" -}}
...
*/}}
{{- define "flask-hello.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "flask-hello.fullname" .) .Values.serviceAccount.name }}
{{- else }}
